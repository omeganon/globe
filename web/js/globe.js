ORBITAL.Globe = function($container, opts) {
    ...
    // determins starting camera position
    var target = { x: Math.PI*3/2, y: Math.PI / 15.0 };
...
// use float lat an lng
        var ll = self.llfloat(lat, lng);
        ...
        // Color control is somehwere here. (point.js)
        point.update({
            flash:true,
            flashOver:true,
